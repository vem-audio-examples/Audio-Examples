...
## F0 Contour Manipulation
We manipulated the F0 contour of neutral yes/no utterances to 7 shapes: flat (used as benchmark in the perception experiment), increasing linear, decreasing linear, convex, concave, cubic(a>0), cubic(a<0).
